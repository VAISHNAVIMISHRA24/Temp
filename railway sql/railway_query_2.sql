create database Railway_Management5;
use Railway_Management5;
 -- drop database Railway_Management5;
--------------------------------------------------------------------------------------------------------------
create table user(
...
truncate table station_schedule;
-------------------------------------------------------------------------------------------------------------------------------
...
insert into insurance_detail values(2302,231102,3,500000,0.50,'Rajkishore Mishra',127890342378);
...
-----------------------------------------------------------------------------------------------------
 ...
 select passenger_name from passenger where passenger_name like '%m%';
